[![Run App ThomasWaller](https://github.com/twaller9/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/twaller9/GithubActions/actions/workflows/run-app.yaml)
